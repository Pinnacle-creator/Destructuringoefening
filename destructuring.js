...
const hz = product.refreshRate;
console.log(amount, hz);
...
const model = productInformation.general.type;
const firm = productInformation.general.brand;
console.log(model, firm);
...
const wireless = tvOptions.options.connectivity.popular.wifi;
const blue = tvOptions.options.connectivity.popular.bluetooth;
console.log(wireless, blue);
...
const school = getCompanyDetails();
console.log(school);
...
const sentence = getDetails.name
